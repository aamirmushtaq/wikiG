import nltk, sys, re, os, urllib2, time, threading, Queue, pymongo
from nltk import *
...
#insert keyword-count dict into mongodb
	def insKeywordCountInDB(self,indict,DBName):
		...
		for keyword,count in indict.items():
			dbh.users.save({"keyword":keyword , "count":count})
...
#retrieve keyword-count dict from mongodb
	def retKeywordCountFromDB(self,DBName):
